...
// Taken from crgimenes/compterm (mterm/width.go, MIT) rather than rewritten.
// The comment below is its own, and the failure it describes is the reason this
// file exists here too.
...
// continuation marks the second column of a wide character. Rune zero cannot
// come from any input, so it says "the cell to my left reaches over me" without
// being mistaken for a space.
